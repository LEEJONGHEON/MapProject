...
public class EmailService {
    ...
    public MimeMessage createMessage(String to, String password)throws MessagingException, UnsupportedEncodingException {
        log.info("보내는 대상 : "+ to);
        ...
        message.setSubject("임시 비밀번호: "); //메일 제목

        // 메일 내용 메일의 subtype을 html로 지정하여 html문법 사용 가능
        String msg="";
        msg += "<h1 style=\"font-size: 30px; padding-right: 30px; padding-left: 30px;\">임시 비밀번호</h1>";
        msg += "<p style=\"font-size: 17px; padding-right: 30px; padding-left: 30px;\">임시 비밀번호입니다. 비밀번호를 변경해주세요. </p>";
    ...
    public String sendSimpleMessage(String to, String password)throws Exception {
        ...
        return password; // 메일로 보냈던 인증 코드를 서버로 리턴
    }
}
